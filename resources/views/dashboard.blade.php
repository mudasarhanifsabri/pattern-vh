        ...
        <div class="tenant-app-screen space-y-5 lg:hidden">
            ...
            @if ($booking)
                ...
                <section class="rounded-[1.6rem] bg-white p-5 shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
                    <div class="flex items-start justify-between gap-3">
                        <div>
                            <p class="text-xs font-black uppercase tracking-[0.18em] text-amber-500">Payments</p>
                            <h2 class="mt-1 text-xl font-black text-[#071a3b]">Invoices & Receipts</h2>
                            <p class="mt-1 text-sm font-semibold leading-6 text-slate-500">See pending invoices, due amounts, approved payments, and receipt PDFs.</p>
                        </div>
                        <span class="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-amber-50 text-amber-600">
                            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 3h12v18H6zM9 7h6M9 11h6M9 15h3"/></svg>
                        </span>
                    </div>
