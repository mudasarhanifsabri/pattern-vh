                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        @forelse($rows as $row)
                            <tr>
                                ...
                                <td class="px-4 py-4">AED {{ number_format($row['owner_expenses'], 2) }}</td>
                        ...
                        @empty
                            <tr><td colspan="9" class="px-4 py-10 text-center text-sm text-slate-500">No approved rent collections found for payout.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
