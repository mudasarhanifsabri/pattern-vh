            ...
            <div class="mt-3 rounded-2xl bg-blue-50 px-4 py-3">
                ...
                <div class="mt-1 flex items-center justify-between gap-3">
                    ...
                    <span class="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-white text-blue-600">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M8 16H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v2" /><path d="M10 8h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-8a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2z" /></svg>
                    </span>
                </div>
            </div>
