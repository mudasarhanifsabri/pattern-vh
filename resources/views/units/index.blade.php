                ...
                @forelse($units as $unit)
                    ...
                    <article class="group overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-950/10">
                        ...
                        <div class="p-5">
                            ...
                            @if($activeBooking)
                                <p class="mt-2 rounded-2xl bg-blue-50 px-3 py-2 text-xs font-bold text-blue-700">
                                    {{ $activeBooking->booking_no }} / {{ $activeBooking->check_in_date?->format('M d') }} to {{ $activeBooking->check_out_date?->format('M d, Y') }}
                                </p>
                            @endif
