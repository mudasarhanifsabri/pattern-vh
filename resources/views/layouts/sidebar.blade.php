    ...
    $menuGroups = [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Finance sheet', 'route' => 'finance-sheet.index', 'active' => 'finance-sheet.*', 'permissions' => ['accounting.view', 'accounting.manage']],
        ...
        [
            ...
            'active' => ['admin.users.*', 'admin.roles.*', 'admin.permissions.*', 'admin.activity-logs.*', 'settings.*', 'software-updates.*', 'tt-lock-settings.*', 'vendors.*', 'profile.*'],
            ...
            'items' => [
                ...
                ['label' => 'Vendors & suppliers', 'route' => 'vendors.index', 'active' => 'vendors.*', 'permissions' => ['users.manage']],
                ...
                ['label' => 'TTLock API groups', 'route' => 'tt-lock-settings.index', 'active' => 'tt-lock-settings.index', 'permissions' => ['users.manage', 'roles.manage']],
                ['label' => 'TTLock locks', 'route' => 'tt-lock-settings.locks.index', 'active' => 'tt-lock-settings.locks.*', 'permissions' => ['users.manage', 'roles.manage']],
                ['label' => 'TTLock activity', 'route' => 'tt-lock-settings.activity', 'active' => 'tt-lock-settings.activity', 'permissions' => ['users.manage', 'roles.manage']],
